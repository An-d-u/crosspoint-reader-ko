...
enum class CssWritingMode : uint8_t { Horizontal = 0, VerticalRl = 1, VerticalLr = 2 };
...
struct CssStyle {
  ...
  CssWritingMode writingMode = CssWritingMode::Horizontal;
  ...
  void reset() {
    ...
    writingMode = CssWritingMode::Horizontal;
    defined.clearAll();
  }
};
