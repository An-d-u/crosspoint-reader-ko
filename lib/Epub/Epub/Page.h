...
class PageElement {
 public:
  ...
  virtual void render(GfxRenderer& renderer, int fontId, int rubyFontId, int xOffset, int yOffset,
                      bool verticalWritingMode) = 0;
...
class PageLine final : public PageElement {
 ...
 public:
  ...
  void render(GfxRenderer& renderer, int fontId, int rubyFontId, int xOffset, int yOffset,
              bool verticalWritingMode) override;
