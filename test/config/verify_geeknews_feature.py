...
def main() -> int:
    ...
    require(activity, "client.connect(address, 443, host", "확인한 IP를 TLS 연결에 재사용하지 않음")
    if "client.connect(host, 443" in activity:
        raise AssertionError("TLS 연결에서 호스트 이름을 다시 DNS 조회하고 있습니다")
