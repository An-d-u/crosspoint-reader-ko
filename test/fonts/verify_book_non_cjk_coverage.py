...
def main() -> int:
    ...
    if missing_counts:
        print("FAIL: current reader builtin font is missing non-CJK codepoints used by local books.")
        print(f" - unique missing codepoints: {len(missing_counts)}")
    ...
    print("PASS: local books do not use non-CJK codepoints missing from the current reader builtin font.")
    return 0
